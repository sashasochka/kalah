...
class Version4Method(Method):
    _name = "Version4"
    _short_name = "Version4"

    def __init__(self, player_num, ai_level=3):
        super(Version4Method, self).__init__(player_num, ai_level)
